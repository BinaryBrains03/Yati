...
import 'schema/video_alert_record.dart';
...
export 'schema/video_alert_record.dart';
...
/// Functions to query VideoAlertRecords (as a Stream and as a Future).
Future<int> queryVideoAlertRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VideoAlertRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VideoAlertRecord>> queryVideoAlertRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VideoAlertRecord.collection,
      VideoAlertRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VideoAlertRecord>> queryVideoAlertRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
