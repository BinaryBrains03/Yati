...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomeWidget() : const HeroWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Buzzer',
          path: '/buzzer',
          builder: (context, params) => const BuzzerWidget(),
        ),
        FFRoute(
          name: 'Alerted',
          path: '/alerted',
        ...
        FFRoute(
          name: 'Hotspots',
          path: '/hotspots',
          builder: (context, params) => const HotspotsWidget(),
        ),
        FFRoute(
          name: 'Hero',
          path: '/hero',
          builder: (context, params) => const HeroWidget(),
        ),
        FFRoute(
          name: 'Report',
          path: '/report',
        ...
        FFRoute(
          name: 'ViewLaws',
          path: '/viewLaws',
          builder: (context, params) => const ViewLawsWidget(),
        ),
        FFRoute(
          name: 'SelfDefence',
          path: '/selfDefence',
          builder: (context, params) => const SelfDefenceWidget(),
        ),
        FFRoute(
          name: 'Admin',
          path: '/admin',
